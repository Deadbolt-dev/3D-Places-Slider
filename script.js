const data = [
    ...
    },
    {
        ...
        title:'GOD\'S OWN',
        title2:'COUNTRY',
        description:'Kerala is a dreamscape of emerald backwaters, swaying coconut palms, and mist-draped hill stations. Drift along serene canals on a traditional houseboat, unwind with authentic Ayurvedic treatments, and lose yourself in the spice-scented air of a land that truly lives up to its name.',
    ...
    {
        place:'Himalaya, India',
        title:'ROOF OF',
        title2:'THE WORLD',
        description:'The Indian Himalayas rise in breathtaking tiers of glaciers, ancient monasteries, and alpine meadows dusted with wildflowers. From the pilgrim trails of Kedarnath to the remote valleys of Spiti, every path leads to a profound encounter with raw, untouched wilderness.',
    ...
    },
    {
        ...
        title:'QUEEN OF',
        title2:'THE HILLS',
        description:'Perched at 2,000 metres above sea level, Darjeeling enchants with rolling tea estates that glow gold at dawn, views of the majestic Kangchenjunga, and the nostalgic charm of the Darjeeling Himalayan Railway toy train winding through clouds and misty ridge-top towns.',
        image:'https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=900&auto=format&fit=crop'
    },
    {
    ...
    },
    {
        ...
        title:'PINK',
        title2:'CITY',
        description:'Jaipur, the jewel of Rajasthan, dazzles with its terracotta-pink palaces, imposing hilltop forts, and labyrinthine bazaars alive with the flash of gemstones and hand-block-printed textiles. A city where royal grandeur meets living culture, every alley tells a thousand-year story.',
...
async function loop() {
  ...
  await step();
  // Wait 5 seconds then check for pause before continuing
  await sleep(2000);
  loop();
}
